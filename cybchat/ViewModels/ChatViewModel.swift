...
class ChatViewModel: ObservableObject, CybchatDelegate {
    ...
    private let nicknameKey = "cybchat.nickname"
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(
            ...
            name: Notification.Name("cybchat.retryMessage"),
            object: nil
        )
    ...
    func panicClearAllData() {
        ...
        userDefaults.removeObject(forKey: "cybchat.noiseIdentityKey")
        userDefaults.removeObject(forKey: "cybchat.messageRetentionKey")
