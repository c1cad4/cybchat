...
/// # CybchatProtocol
///
/// Defines the application-layer protocol for CybChat mesh networking, including
/// message types, packet structures, and encoding/decoding logic.
///
/// ## Overview
/// CybchatProtocol implements a binary protocol optimized for Bluetooth LE's
