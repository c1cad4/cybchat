...
class BluetoothMeshService: NSObject {
    ...
    private let collectionsQueue = DispatchQueue(label: "cybchat.collections", attributes: .concurrent)
    ...
    private let messageQueue = DispatchQueue(label: "cybchat.messageQueue", attributes: .concurrent) // Concurrent queue with barriers
    ...
    private let connectionStateQueue = DispatchQueue(label: "chat.cybchat.connectionState", attributes: .concurrent)
    ...
    private func getEncryptionQueue(for peerID: String) -> DispatchQueue {
        ...
        let queue = DispatchQueue(label: "cybchat.encryption.\(peerID)", qos: .userInitiated)
