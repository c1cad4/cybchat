...
class NoiseSession {
    ...
    // Thread safety
    private let sessionQueue = DispatchQueue(label: "chat.cybchat.noise.session", attributes: .concurrent)
...
class NoiseSessionManager {
    ...
    private let localStaticKey: Curve25519.KeyAgreement.PrivateKey
    private let managerQueue = DispatchQueue(label: "chat.cybchat.noise.manager", attributes: .concurrent)
